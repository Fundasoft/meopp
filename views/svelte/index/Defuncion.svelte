<script>
    ...
    let isOpenArray = Array(subsidiosDefuncion.length).fill(false);
...
<div class="page-container">
    <div class="page-header">
        <h1 class="page-title">Subsidios por Defunción</h1>
        <p class="page-subtitle">Selecciona el tipo de subsidio por defunción que corresponda a tu situación</p>
    </div>

    {#each subsidiosDefuncion as item, index}
        <div class="container">
